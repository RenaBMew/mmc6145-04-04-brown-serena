...
export default function Book() {
  ...
  // TODONE: Use dispatch appropriately to add/remove books - handle it
  ...
  return (
    <main>
      ...
      <div className={styles.controls}>
        {isFavoriteBook ? (
          // TODONE: add onClick function that calls dispatch to remove a book - handleRemoveFavorite
          <button onClick={handleRemoveFavorite}>Remove from Favorites</button>
        ) : (
          // TODONE: add onClick function that calls dispatch to add a book - handleAddFavorite
